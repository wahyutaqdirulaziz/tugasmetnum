...
*/
    ...
    private void populateList() {
        ...
        w = math.getValueW(fa, fb);
        c = math.getValueC(a, b, w);
      ...
      /*  Toast.makeText(getApplicationContext(), String.valueOf(fa) + " " +
        ...
        for (int i= 0; i<100; i++){
            ...
            if (math.evaluateFunction(fa, fc)) {
                fa = math.initializeFunction(function, c);
                w = math.getValueW(fa, fb);
                c = math.getValueC(c, b, w);
            } else {
                fb = math.initializeFunction(function, c);
                w = math.getValueW(fa, fb);
                c = math.getValueC(a, c, w);
            }
